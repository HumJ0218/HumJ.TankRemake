...
{
    public class BulletExplosionGun(Vector2 position, EntityDirection direction, Vector2 speed, Camp camp) : BulletBase(position, direction, speed, 60, camp)
    {
        public override WeaponType Type => WeaponType.Explosion;
