...
{
    public class BulletNormalGun(Vector2 position, EntityDirection direction, Vector2 speed, Camp camp) : BulletBase(position, direction, speed, 50, camp)
    {
        public override WeaponType Type => WeaponType.Normal;
